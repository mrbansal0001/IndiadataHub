...
def update_comparison_gap_chart(selected_states, selected_attribute):
    ...
    if not selected_states or not selected_attribute or len(selected_states) < 2:
        placeholder_fig = go.Figure()
        placeholder_fig.update_layout(
            title="📈 Performance Gap Analysis - Select 2+ states and an attribute",
            title_x=0.5,
            title_font_size=18,
            title_font_weight="bold",
            title_font_color="#64748b",
            ...
            annotations=[
                dict(
                    text="🎯 Choose 2+ states and an attribute for gap analysis!",
                    xref="paper", yref="paper",
                    x=0.5, y=0.5,
                    xanchor='center', yanchor='middle',
                    font=dict(size=16, color="#94a3b8"),
    ...
    try:
        ...
        # Beautiful styling
        fig.update_layout(
            title=f"📈 Performance Gap Analysis: {get_short_label(selected_attribute)}",
            title_x=0.5,
            title_font_size=18,
            title_font_weight="bold",
            title_font_color="#2d3748",
        ...
        fig.add_annotation(
            x=0.02, y=0.98,
            xref="paper", yref="paper",
            text=f"📊 National Avg: {national_avg:.1f}%<br>" +
                 f"🥇 Top Performer: {top_performer:.1f}%<br>" +
